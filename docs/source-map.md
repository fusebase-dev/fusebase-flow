...
- All 7 canonical SKILL.md `Clean-room note` sections (`skills/<slug>/SKILL.md`).
...
2. Standard wording presence — `preflight.sh` is configured to inspect skill frontmatter; manual review of clean-room notes confirms the standard wording in all 7 canonical + 14 mirror SKILL.md files.
