...
| `ci-linux-msys-test-divergence` | high | resolved | Six cross-platform traps covered: history depth, shared PATH dirs, file modes, fixture manifests, fixture EOL policy, and native CRLF on typed multi-line output |
