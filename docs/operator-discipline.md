...
> Expectations for the **human operator** (you) when running Fusebase Flow. This document is for humans, not AI agents — the agent enforces FR-01..FR-21 from `FLOW_RULES.md` on its side; you carry the operator side.
>
