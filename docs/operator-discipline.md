...
> Expectations for the **human operator** (you) when running Fusebase Flow Local. This document is for humans, not AI agents — the agent enforces FR-01..FR-15 from `FLOW_RULES.md` on its side; you carry the operator side.
>
...
- `FLOW_RULES.md` — FR-01..FR-15 (the agent-side rules)
