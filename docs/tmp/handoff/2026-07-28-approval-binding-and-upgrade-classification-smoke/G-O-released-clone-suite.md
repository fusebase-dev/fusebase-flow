...
[run-tests] fixture handler tests (single-process) took 1s
...
[run-tests] module-size ratchet took 25s
...
[run-tests] health-check-timeout scenarios took 99s
...
[run-tests] hook-manifest took 7s
...
[run-tests] newline-preserve took 7s
...
[run-tests] baseline-merge took 5s
...
[run-tests] sync-allowlist took 7s
...
[run-tests] bootstrap-baseline-hop took 6s
...
[run-tests] po-verifiable-boot took 7s
...
[run-tests] po-investigate took 10s
...
PASS: liveness f3-fast-child-returns-well-under-budget (2s wall for a 600s-budget instant child, own rc=0 — reap loop did not block for the budget; nap ladder, not a 1s sleep floor)
...
[run-tests] codex-parity took 59s
...
[run-tests] codex-plugin took 4s
...
[run-tests] secret-scan-staged took 207s
...
[run-tests] bootstrap-exception took 371s
...
[run-tests] trusted-enforcer took 256s
...
[run-tests] hook-install-rc took 16s
...
[run-tests] msys-tree-cleanup took 62s
...
PASS: msys-tree-cleanup ws2-no-hang-large-budget (returned in 1s with the command's own rc=7, not the 300s budget)
...
PASS: msys-tree-cleanup ws2hard-job-sibling-survives (unrelated bash sleep pid=343121 alive after the fence's TerminateJobObject — assigned-tree-only, no collateral)
...
PASS: msys-tree-cleanup ws2-concurrent-sibling-survives (unrelated bash sleep pid=343394 alive after a bounded op's timeout-taskkill — reap scoped to recorded child only)
[run-tests] starting ws5-upgrade
[run-tests] ws5-upgrade took 42s
PASS: ws5-upgrade w1-prune-single-pass (single-pass: 154 -> 93 backups (keep 3/stem), 61 pruned, terminated in 9s — no per-stem busy-loop)
...
[run-tests] return-budget took 4s
...
[run-tests] supersede-primitive took 6s
...
[run-tests] rule-inventory took 198s
...
[run-tests] prohibition-residency took 59s
...
[run-tests] token-waste-classify took 19s
...
[run-tests] budget-literals took 41s
...
[run-tests] history-extraction took 4s
...
[run-tests] approval-binding took 5s
...
[run-tests] approval-writer took 18s
...
[run-tests] command-policy took 5s
...
[run-tests] upgrade-classify took 90s
...
[run-tests] cli-flow-recovery (0.25.9-era wired-set model; unchanged through 0.25.16) took 481s
...
[run-tests] report written: C:/tmp/ff470/gate470/state/audit/hook-test-results.md
GO_RC=1
```
