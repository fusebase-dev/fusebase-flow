...
This repo runs **Fusebase Flow v4.17.1**. Read `AGENTS.md`, `FLOW_RULES.md` through `## Amendment log`, both mandatory skill bodies, `flow-skills/role-discipline/references/<role>.md`, and the active workflow/ticket artifacts. Canonical provider details are in the recovery-owned adapter below.
