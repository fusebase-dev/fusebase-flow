...
**Status:** v0.10 (FR-23 added in v3.12 — documentation budget; documentation-overhead reduction initiative)
...
Every role declares: "Operating as {role} under Fusebase Flow v3.12.1. I will follow FR-01 through FR-23. I will apply Mode A on chat output and Mode B on every internal-artifact write. I will apply the role-discipline skill section for {role}."
