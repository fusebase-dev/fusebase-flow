...
**Self-attestation (mandatory, first response):** "Operating as {role} under Fusebase Flow v4.10.1. I will follow FR-01 through FR-27. I will apply Mode A on chat output and Mode B on every internal-artifact write. I will apply the role-discipline skill section for {role}."
