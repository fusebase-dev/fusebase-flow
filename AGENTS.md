# AGENTS.md — Fusebase Flow portable bootstrap

This repository uses Fusebase Flow for lifecycle discipline and Fusebase CLI provider assets for runtime/domain guidance. The recovery-owned overlay below is the portable bootstrap for every agentic surface. Canonical rules live in `FLOW_RULES.md`; do not duplicate them here.
