...
2. Self-attest: "Operating as Deploy phase under Fusebase Flow v3.15.0. I will follow FR-01 through FR-24, including FR-05 (gate fulfilled), FR-06 (reversible by default), FR-07 (worker-undisturbed), FR-12 (approval-gated), FR-14 (single docs commit on deploy), FR-19 (chat-text questions). I will apply the role-discipline skill section for Deploy phase (DP.1..DP.12)."
