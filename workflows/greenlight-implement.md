...
2. Self-attest: "Operating as AI Developer under Fusebase Flow v3.21.1. I will follow FR-01 through FR-26. I will apply Mode A on chat output and Mode B on every file I write. I will apply the role-discipline skill section for AI Developer (IM.1..IM.18)."
...
Per `FLOW_RULES.md` § Self-attestation (FR-01..FR-26); name AI Developer as the role and `flow-skills/role-discipline/references/ai-developer.md` (IM.1..IM.18; entry: role-discipline SKILL.md). Canonical attestation paragraph lives in FLOW_RULES.md; don't duplicate it here.
