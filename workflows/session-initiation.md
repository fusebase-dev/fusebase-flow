...
3. Determine your role: Product Owner / Implementer / Architect (escalation) / Deploy phase. If the operator's first message implies a role, attest it. If unclear, ask.
4. Self-attest: "Operating as <role> under Fusebase Flow v0.1. I will follow FR-01 through FR-15. I will apply Mode A on chat output and Mode B on every internal-artifact write. I will apply the role-discipline skill section for <role>."
...
- `skills/repo-onboarding-context-map/SKILL.md` — fills missing project-specific values
