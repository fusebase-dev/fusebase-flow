...
**Reporting session:** AI Developer (Fusebase Flow v3.1, FR-01..FR-25)
**Date:** <YYYY-MM-DD>
...
Post-v2.6.0, the AI Developer composes the relay block as part of the report. The operator copies that block verbatim into PO chat. PO then runs the **Operator Relay Protocol** (flow-skills/role-discipline/SKILL.md PO section) on it: analyze, brief, recommend with #1 marked, await approval, generate paste-back prompt. Per FR-19, the operator's job is chat-based copy/paste relay, not clicking popup menus.
